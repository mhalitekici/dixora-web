...
PERMISSION_DESCRIPTIONS: dict[str, str] = {
    ...
    "orders.comp": "Mark order items as complimentary",
    "payments.manage": "Record and manage payments",
    "cashier.shift.manage": "Open and close cashier shifts",
    "cashier.day.close": "Close and reconcile a branch business day",
